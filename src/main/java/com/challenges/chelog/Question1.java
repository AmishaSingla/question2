...
public class Question1{
    ...
    /**
    * This method returns the downtime of a workspace in rounded hours.
    * variable intern will have person name as input.using that person name calculate the downtime for that particular person.  
